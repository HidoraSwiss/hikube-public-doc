...
:::tip Bon à savoir
Chaque bucket créé via l’API Hikube est stocké sur une infrastructure **triple-répliquée** et bénéficie de la Hochverfügbarkeit native du cluster S3.
:::
